export async function runMigrations(): Promise<void> {
  ...
  console.log('[Migration] File: backend/src/db/migrations/001_payroll_leave_schema.sql')
  console.log('[Migration] Steps:')
  console.log('[Migration]   1. Open https://supabase.com/dashboard')
  console.log('[Migration]   2. SQL Editor → New query')
  console.log('[Migration]   3. Paste contents of 001_payroll_leave_schema.sql')
